...
| `npm test` | 118 tests : autorisations, stockage et adresses signees, chemins de medias, limitation de debit, catalogue, albums, paiements, abonnements, mots de passe, identifiants, scripts |
...
- `ADMIN_PIN` — second facteur de la console d'administration, jamais dans le
  depot
...
- **118 tests automatises** (`npm test`, sans dependance de test) sur les
